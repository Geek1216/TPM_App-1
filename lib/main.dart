...
import 'package:tpmapp/constants/new_url.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    NewUrl.newUrl = _preferencesService.getNewBaseURl;
    ...
    return MultiProvider(
      ...
      child: MaterialApp(
        ...
        routes: {
          Routes.modeSelection: (_) => Consumer<PreferencesService>(builder: (_, pref, __) => ModeSelectionScreen(pref)),
          Routes.jobScreen: (_) => JobScreen(_preferencesService),
          Routes.tubeMillSetupForm: (_) => TubeMillSetupForm(_preferencesService),
          ...
          Routes.cutoffStationCheckSheet: (_) => CutoffStationCheckSheet(_preferencesService),
          Routes.directPackInspection: (_) => DirectPackInspectionScreen(_preferencesService),
          Routes.finalInspectionGeoForm: (_) => FinalInspectionGeoForm(_preferencesService),
          Routes.inspectionStationCheckSheet: (_) => InspectionStationCheckList(_preferencesService),
          Routes.tpmappGeoformRingInspection: (_) => GeoFormRingInspection(_preferencesService),
          Routes.ringStationCheckSheet: (_) => RingStationCheckSheet(_preferencesService),
          Routes.jobWaitingScreen: (_) =>
              Consumer2<PreferencesService, JobListStore>(builder: (_, pref, store, __) => JobWaitingScreen(pref, store)),
          Routes.formSelectionScreen: (_) => FormSelectionScreen(_preferencesService),
          Routes.deviceSetupScreen: (_) => DeviceSetupScreen(_preferencesService),
          Routes.serverSetup: (_) => Serversetup(_preferencesService),
          Routes.tackWeldSheet: (_) => TackWeldSheet(_preferencesService),
          Routes.geoInspectionStationCheckSheet: (_) => GeoInspectionStationCheckList(_preferencesService),
          Routes.geoCutoffStationCheckSheet: (_) => GeoCutoffStationCheckSheet(_preferencesService),
          Routes.geoformSelectionScreen: (_) => GeoFormSelectionScreen(_preferencesService),
          Routes.tubeSelectionScreen: (_) => TubeSelectionScreen(_preferencesService),
          ...
          Routes.jobScreenStamping: (_) =>
              Consumer2<PreferencesService, JobListStore>(builder: (_, pref, store, __) => JobScreenStamping(pref, store)),
          ...
          Routes.jobScreenSteelReceiving: (_) => JobScreenSteelReceiving(_preferencesService),
