...
class GeoInspectionStationCheckList extends StatefulWidget {
  final PreferencesService pref;

  GeoInspectionStationCheckList(this.pref, {Key key}) : super(key: key);
  @override
  _GeoInspectionStationCheckListState createState() =>
      _GeoInspectionStationCheckListState();
}

class _GeoInspectionStationCheckListState
    extends State<GeoInspectionStationCheckList> {
  double height = 0;
  double width = 0;
