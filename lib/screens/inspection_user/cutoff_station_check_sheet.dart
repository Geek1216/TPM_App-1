...
class CutoffStationCheckSheet extends StatefulWidget {
  final PreferencesService pref;

  CutoffStationCheckSheet(this.pref, {Key key}) : super(key: key);
  @override
  _CutoffStationCheckSheetState createState() =>
      _CutoffStationCheckSheetState();
}

class _CutoffStationCheckSheetState extends State<CutoffStationCheckSheet> {
  ...
  void initState() {
    ...
    if (data['formData']['nextTubeCut'] != "") {
      widget.pref.currentTubeNo = data['formData']['nextTubeCut'];
...
//                        SizedBox(
//                          width: width * 0.48,
//                          child: Text('Date Started: 18-Jun-2020',
//                              style: bigBoldFontStyle.copyWith()),
//                        ),
                      ],
                    ),
                        ...
                        onPressed: () async {
                          ...
                          if ((!_issueLenStart) &&
                            ...
                            if (data['formData']['nextTubeCut'] == "") {
                              ...
                              // if (int.parse(data['formData']['nextTubeCut']
                              //         .substring(data['formData']['nextTubeCut']
                              //                 .indexOf('-') +
                              //             1)) <
                              //     int.parse(widget.pref.currentTubeNo.substring(
                            ...
                            //     details, data, widget.pref, 'cSCs', qty);
                            // remTubes =
                            //     MyUtils.calRemainingJob(data, details, 'cSCs');
